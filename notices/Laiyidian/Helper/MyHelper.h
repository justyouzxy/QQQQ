...
//property声明一个字符串
#define PreNoCopyString(object) @property (nonatomic, copy) NSString *object;
//property声明一个数组
#define PreNoStrongArray(object) @property (nonatomic, strong) NSString *object;
//property声明一个字典
#define PreNoStrongDictonary(object) @property (nonatomic, strong) NSString *object;
//property声明一个Number
#define PreNoStrongNumber(object) @property (nonatomic, strong) NSNumber *object;
//propertyStrong声明一个class类型的object对象
#define PropertyStrong(class, object) @property (nonatomic, strong) class *object;
//propertyAssign声明一个class类型的object对象
#define PropertyAssign(class, object) @property (nonatomic, assign) class object;
