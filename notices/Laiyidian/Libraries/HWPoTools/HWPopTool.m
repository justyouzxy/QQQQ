...
- (void)showWithPresentView:(UIView *)presentView animated:(BOOL)animated {
    ...
    NSLog(@"%f %f",containerViewRect.origin.x,containerViewRect.origin.y);
...
- (void)closeWithPresentVIew:(UIView *)presentView animated:(BOOL)animated {
    [self close];
}
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (!self) {
        ...
        styleLayer.shadowColor= [[UIColor blueColor] CGColor];
        ...
        styleLayer.frame = CGRectInset(self.bounds, Pading, Pading);
//        NSLog(@" MyView %f,%f",styleLayer.frame.size.width,styleLayer.frame.size.height);
